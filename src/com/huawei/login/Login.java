...
public class Login extends JFrame {
	...
	public Login() {
		...
		setIconImage(tookit.getImage("res/icon.png"));
		...
		login.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				...
				try {
					...
					user = userDAO.getUserByUsernameAndPassword(userName.getText(), new String(userPassword.getPassword()));
