...
public class JXCFrame {
	...
	public JXCFrame() {
		...
		frame.setIconImage(tookit.getImage("res/icon.png"));
	...
	private JInternalFrame getIFrame(String frameName) {
		...
		if (!ifs.containsKey(frameName)) {
			try {
				...
				jf = (JInternalFrame) fClass.newInstance();
	...
	protected final class openFrameAction extends AbstractAction {
		...
		public void actionPerformed(final ActionEvent e) {
			...
			jf.setLocation((desktopPane.getWidth()-jf.getWidth())/2, (desktopPane.getHeight()-jf.getHeight())/2);
